  ...
  return (
    <Layout>
      <Head>
        ...
        <meta content="Learn more about Sam Yang, a software engineer based in Tokyo with a passion for technology and cross-cultural experiences." name="description" />
      </Head>
              ...
              >
                <AccordionSummary expandIcon={<ExpandMore />}>
                  <Box sx={{ alignItems: 'center', display: 'flex' }}>
                    ...
                    <Typography color="primary" variant="h5">My Programming Journey</Typography>
                  </Box>
                </AccordionSummary>
                <AccordionDetails>
              ...
              >
                <AccordionSummary expandIcon={<ExpandMore />}>
                  <Box sx={{ alignItems: 'center', display: 'flex' }}>
                    ...
                    <Typography color="primary" variant="h5">Sports & Activities</Typography>
                  </Box>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography paragraph variant="body1">
              ...
              >
                <AccordionSummary expandIcon={<ExpandMore />}>
                  <Box sx={{ alignItems: 'center', display: 'flex' }}>
                    ...
                    <Typography color="primary" variant="h5">Life in Japan</Typography>
                  </Box>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography paragraph variant="body1">
              ...
              >
                <AccordionSummary expandIcon={<ExpandMore />}>
                  <Box sx={{ alignItems: 'center', display: 'flex' }}>
                    ...
                    <Typography color="primary" variant="h5">Goals & Aspirations</Typography>
                  </Box>
                </AccordionSummary>
                <AccordionDetails>
                  <Typography paragraph variant="body1">
